...
class Point(object):
    """ Objects are a point located in 2-space"""
    ...
    def move_to(self, x, y):
        dis_moved = Point.get_distance_from(self, Point(x, y))
        self.total_dis = self.total_dis + dis_moved
        self.x = x
        self.y = y
        self.number_of_moves = self.number_of_moves + 1

    def move_by(self, dx, dy):
        dis_moved = Point.get_distance_from(self, Point(self.x + dx, self.y +
                                                        dy))
        self.total_dis = self.total_dis + dis_moved
        self.x = self.x + dx
        self.y = self.y + dy
    ...
    def closer_to(self, p2, p3):
        dis_p2 = Point.get_distance_from(self, p2)
        dis_p3 = Point.get_distance_from(self, p3)
    ...
    def halfway_to(self, p2):
        ...
        point = Point(self.x + dx / 2, self.y + dy / 2)
        return point
